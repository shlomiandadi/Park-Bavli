...
export const metadata = {
  ...
  icons: {
    icon: [
      { url: '/images/park-bavli-logo%20black.png', type: 'image/png' },
    ],
    apple: [
      { url: '/images/park-bavli-logo%20black.png', sizes: '180x180', type: 'image/png' },
    ],
  },
  openGraph: {
    title: 'Park Bavli Tel Aviv | PEER Luxury Real Estate',
    ...
    images: [
      {
        url: '/images/park-bavli-logo%20black.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['/images/park-bavli-logo%20black.png'],
  },
  robots: {
    index: true,
    follow: true,
